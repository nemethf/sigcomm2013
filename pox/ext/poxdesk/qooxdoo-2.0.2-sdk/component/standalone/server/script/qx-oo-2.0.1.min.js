...
(function(){var k='"',j="Unsupported type!",h="change",g="qx.data.marshal.Json",f="set",e="_applyEventPropagation",d="",c="Array",b="_validate",a="qx.data.model.";qx.Class.define(g,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(l){qx.core.Object.call(this);this.__tV=l;}
...
},members:{__tV:null,__tW:function(o){return qx.Bootstrap.getKeys(o).sort().join(k);}
...
;}
;return;}
;var s=this.__tW(p);for(var t in p){this.toClass(p[t],q);}
;if(qx.Class.isDefined(a+s)){return;}
;if(this.__tV&&this.__tV.getModelClass&&this.__tV.getModelClass(s)!=null){return;}
;var z={};var y={__tX:this.__tX};for(var t in p){if(this.__tV&&this.__tV.getPropertyMapping){t=this.__tV.getPropertyMapping(t,s);}
;t=t.replace(/-|\.|\s+/g,d);{}
;z[t]={};z[t].nullable=true;z[t].event=h+qx.lang.String.firstUp(t);if(q){z[t].apply=e;}
;if(this.__tV&&this.__tV.getValidationRule){var v=this.__tV.getValidationRule(s,t);if(v){z[t].validate=b+t;y[b+t]=v;}
;}
;}
;if(this.__tV&&this.__tV.getModelSuperClass){var x=this.__tV.getModelSuperClass(s)||qx.core.Object;}
else {var x=qx.core.Object;}
;var u=[];if(this.__tV&&this.__tV.getModelMixins){var w=this.__tV.getModelMixins(s);if(!qx.lang.Type.isArray(w)){if(w!=null){u=[w];}
;}
else {u=w;}
;}
;if(q){u.push(qx.data.marshal.MEventBubbling);}
;var r={extend:x,include:u,properties:z,members:y,destruct:this.__tY};qx.Class.define(a+s,r);}
,__tY:function(){var A=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var B in A){this.__tX(this.get(A[B].name));}
;}
,__tX:function(C){if(!(C instanceof qx.core.Object)){return;}
;if(C.isDisposed()){return;}
;C.dispose();}
,__ua:function(D){var E;if(this.__tV&&this.__tV.getModelClass){E=this.__tV.getModelClass(D);}
...
;return N;}
else if(L){var I=this.__tW(G);var O=this.__ua(I);for(var M in G){var J=M;if(this.__tV&&this.__tV.getPropertyMapping){J=this.__tV.getPropertyMapping(M,I);}
