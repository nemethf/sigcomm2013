...
dec.setEndColor("#3f406b");
	...
	var dec2 = new qx.ui.decoration.Background();
	dec2.setBackgroundImage("icon/22/apps/utilities-calculator.png");
	dec2.setBackgroundImage("https://www.tmit.bme.hu/img/heading_norm.png");
	dec2.setBackgroundImage("poxdesk/bme.png");
	dec2.setBackgroundRepeat("no-repeat");
	dec2.setBackgroundPositionX("right");
	dec2.setBackgroundPositionY("bottom");
	dec2.setBackgroundColor("#CD9B5C");
	dec2.setBackgroundColor("#4f506b");

desktop.set({decorator: dec2});
...
*/
      ...
      this.addToStart("LinkUtilization", function () { new poxdesk.LinkUtilization(); }, "icon/22/apps/utilities-statistics.png");
      this.addToStart("TopoSelector", function () { new poxdesk.TopoSelector(); }, "icon/22/categories/system.png");
      this.addToStart("TopoViewer", function () { new poxdesk.TopoViewer(); }, "icon/22/categories/internet.png");
      this.addToStart("Map", function () { new poxdesk.Map(); }, "icon/22/categories/internet.png");
