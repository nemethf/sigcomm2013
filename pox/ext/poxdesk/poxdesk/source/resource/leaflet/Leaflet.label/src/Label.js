...
//		offset: new L.Point(12, -15), // 6 (width of the label triangle) + 6 (padding)
  ...
  setStyle: function()
  {
    ...
    this._container.style.bgColor="white";
    this._container.style.boxShadow="10px 10px 5pxs #999999";
    this._container.style.border="1px solid red";
//    this._container.style.MozTransform = "rotate(30rad)";
    console.log(L.DomUtil.getStyle(this._container,"MozTransform").toString());
  },
	onAdd: function (map) {
		this._map = map;
